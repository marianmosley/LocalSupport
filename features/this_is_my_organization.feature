Feature: This is my organization
  ...
  Background:
    ...
    | admin@myorg.com           | adminpass0987  | true  | 2008-01-01 00:00:00 |                 | false                 |
    | charityadmin@myorg.com    | adminpass0987  | false | 2008-01-01 00:00:00 | My Organization | false                 |
...
Scenario: I am a charity admin so I am redirected to my charity's page and I do not see the This is My Organization button
  Given I am on the sign in page
  And I sign in as "charityadmin@myorg.com" with password "adminpass0987"
  Then I should be on the charity page for "My Organization"
